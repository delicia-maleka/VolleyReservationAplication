...
* The original package name 'fr.univ.tours.jakartaee..volley-reservation' is invalid and this project uses 'fr.univ.tours.jakartaee.volley_reservation' instead.
